...
| :--- | :---: | :--- |
| **Posicionamento de Perfil** | <img src="./banners-perfil/banner-perfil-visao_clareza_e_estrutura_.v1.png" width="375" alt="Banner Perfil Visão Clareza Estrutura"> | Composição visual focada em visão, clareza e estrutura. |
| **Hub Principal de Projetos** | <img src="./banners-hub/banner-hub_de_projetos-prisma-curadoria-fundo_escuro_v3.png" width="375" alt="Banner Hub Projetos"> | Símbolo da simplificação do complexo através da centralização estética sob o prisma da curadoria. |
| **Presença Digital (Corporate)** | <picture><source media="(prefers-color-scheme: dark)" srcset="./presenca-digital/Dio-logo.png"><source media="(prefers-color-scheme: light)" srcset="./presenca-digital/Dio-logo.png"><img src="./presenca-digital/Dio-logo.png" width="50" style="background-color: #1f242c; padding: 4px; border-radius: 4px;" alt="Dio Logo"></picture> \| <img src="./presenca-digital/GitHub-logo.png" width="35" alt="GitHub Logo"> | Avatares, selos de identidade e assinaturas de comunidades profissionais. |
| **Identidade Corporativa** | <img src="./banners-hub/GitHub-logo_completo.png" width="100"> <img src="./banners-hub/Linkedin-logo.png" width="100"> <img src="./banners-hub/DIO-logo-make_the_change.png" width="100"> | Elementos de marcas institucionais. |
...
| **Artigo Autoral (Capa Principal)** | <img src="./badges-artigos_e_projetos/artigo-banner-capa_arvore_digital-Gemini_v2.png" width="375" alt="Capa Árvore Digital"> | Capa desenvolvida utilizando IA através do método de Calibragem Interativa por Camadas para publicação autoral. |
| **Artigo Autoral (Artes Complementares)** | <img src="./badges-artigos_e_projetos/artigo-imagem-malha_de_dados_digitais-ChatGPT_v1.png" width="100" alt="Malha de Dados Digitais"> \| <img src="./badges-artigos_e_projetos/artigo-imagem-camadas_flutuantes-ChatGPT_v2.png" width="100" alt="Camadas Flutuantes"> | Ilustrações desenvolvidas utilizando IA através do método de Calibragem Interativa por Camadas para publicação autoral. |
