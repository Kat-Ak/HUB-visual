...
| :--- | :---: | :--- |
| **Posicionamento de Perfil** | <img src="./banners-perfil/banner-perfil-visao_clareza_e_estrutura_.v1.png" width="375" alt="Banner Perfil Visão Clareza Estrutura"> | Arquitetura Estética focada em visão (clareza, estrutura e toque humano). |
| **Hub Principal de Projetos** | <img src="./banners-hub/banner-hub_de_projetos-prisma-curadoria-fundo_escuro_v3.png" width="375" alt="Banner Hub Projetos"> | Narrativa gráfica do prisma da curadoria como símbolo da simplificação do complexo que transforma caos em ordem. |
| **Presença Digital (Corporate)** | <img src="./presenca-digital/GitHub-logo.png" width="25" alt="GitHub Logo"> \| <img src="./presenca-digital/Linkedin-in-logo.png" width="35" alt="LinkedIn Logo"> \| <img src="./presenca-digital/Dio-logo.png" width="35" alt="Dio Logo"> | Avatares, selos de identidade e assinaturas de comunidades profissionais. |
| **Identidade Corporativa** | <img src="./banners-hub/GitHub-logo_completo.png" width="100"> \| <img src="./banners-hub/Linkedin-logo.png" width="100">\| <img src="./banners-hub/DIO-logo-make_the_change.png" width="150">  | Elementos de marcas institucionais. |
