...
| **Hub Principal de Projetos** | <img src="./banners-hub/banner-hub_de_projetos-prisma-curadoria-fundo_escuro_v3.png" width="375" alt="Banner Hub Projetos"> | Símbolo da simplificação do complexo através da centralização estética sob o prisma da curadoria (caos em ordem). |
